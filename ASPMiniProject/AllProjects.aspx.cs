...
namespace ASPMiniProject
{
    public partial class AllProjects : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            gvAllProjects.DataSource = projectObj.GetAllProjectstoAdmin();
        ...
        protected void GridView1_SelectedIndexChanged(object sender, EventArgs e)
        {
           ...
           // Response.Redirect("Pay.aspx?ProjectName="+ProjectName+"&TeamLeader="+TeamLeader+"&Phone="+Phone+"&Email="+Email+"&Amount="+amount+"&EmployeeId="+EmployeeId+"&ProjectId="+projectId);
        }
